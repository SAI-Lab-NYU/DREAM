...
from dream.model.modeling_llava_next import LlavaNextForConditionalGeneration
...
with gr.Blocks(css=custom_css) as demo:
    ...
    with gr.Row():
        with gr.Column():
            use_EaInfer = gr.Checkbox(label="Use DREAM", value=True)
            highlight_EaInfer = gr.Checkbox(label="Highlight the tokens generated by DREAM", value=True)
    ...
    note=gr.Markdown(show_label=False,interactive=False,value='''The Compression Ratio is defined as the number of generated tokens divided by the number of forward passes in the original LLM. If "Highlight the tokens generated by DREAM" is checked, the tokens correctly guessed by DREAM 
